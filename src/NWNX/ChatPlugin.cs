namespace NWN.Core.NWNX {
  ...
  public class ChatPlugin {
    ...
    public static int SendMessage(int channel, string message, uint sender = NWScript.OBJECT_INVALID,
      uint target = NWScript.OBJECT_INVALID) {
    ...
    public static void SetChatHearingDistance(float distance, uint listener = NWScript.OBJECT_INVALID,
    ...
    public static float GetChatHearingDistance(uint listener = NWScript.OBJECT_INVALID,
      int channel = NWNX_CHAT_CHANNEL_PLAYER_TALK) {
